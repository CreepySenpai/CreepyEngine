#include <Platform2/OpenGL/OpenGLFrameBuffer.hpp>
...
namespace Creepy {
    ...
    OpenGLFrameBuffer2::OpenGLFrameBuffer2(const FrameBufferSpecification& data) noexcept : m_data{data} {
    ...
    OpenGLFrameBuffer2::~OpenGLFrameBuffer2() noexcept {
    ...
    void OpenGLFrameBuffer2::BindImpl() noexcept {
        glBindFramebuffer(GL_FRAMEBUFFER, m_rendererID);
        glViewport(0, 0, m_data.Width, m_data.Height);
    }

    void OpenGLFrameBuffer2::UnBindImpl() noexcept {
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
    }

    constexpr uint32_t maxFrameSize = 9000u;

    void OpenGLFrameBuffer2::ResizeImpl(uint32_t width, uint32_t height) noexcept {
    ...
    int OpenGLFrameBuffer2::ReadPixelImpl(uint32_t attachmentIndex, int x, int y) noexcept {
    ...
    void OpenGLFrameBuffer2::ClearColorBufferAttachmentImpl(uint32_t attachmentIndex, int value) noexcept {
        ENGINE_ASSERT((attachmentIndex < m_colorBufferAttachments.size()), "Attachment index > 32");
    ...
    void OpenGLFrameBuffer2::InvalidateImpl() noexcept {
